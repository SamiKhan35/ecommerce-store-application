...
// import { fethingSingleData } from "../myredux/userSlice";
            ...
            return (
              <div
               ...
               >
                ...
                <br></br>
                <button className="bg-black text-white w-[100%] h-[30px] text-[15px] hover:bg-red-600" >
                  Add To Cart
                </button>
              </div>
            );
